    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceSkillMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResourceSkillMappings_Resources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceSkillMappings_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chapters_Stacks_StackId",
                        column: x => x.StackId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenLookup = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredEducationLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    RequiredFieldOfStudy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceRatings_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSeenQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentSeenQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentSeenQuestions_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChapterScoresJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WeakChapterIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationMatchSnapshots",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationId = table.Column<int>(type: "int", nullable: false),
                    RequirementFit = table.Column<double>(type: "float", nullable: false),
                    OptionalFit = table.Column<double>(type: "float", nullable: false),
                    EducationBonus = table.Column<double>(type: "float", nullable: false),
                    MissingSkillIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ComputedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationMatchSnapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationMatchSnapshots_Applications_ApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationMatchSnapshots_ApplicationId",
                table: "ApplicationMatchSnapshots",
                column: "ApplicationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Applications_StudentId_VacancyId",
                table: "Applications",
                columns: new[] { "StudentId", "VacancyId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_TokenLookup",
                table: "RefreshTokens",
                column: "TokenLookup",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceRatings_ResourceId_StudentId",
                table: "ResourceRatings",
                columns: new[] { "ResourceId", "StudentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ResourceRatings_StudentId",
                table: "ResourceRatings",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceSkillMappings_ResourceId_SkillId",
                table: "ResourceSkillMappings",
                columns: new[] { "ResourceId", "SkillId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ResourceSkillMappings_SkillId",
                table: "ResourceSkillMappings",
                column: "SkillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSeenQuestions_QuestionId",
                table: "StudentSeenQuestions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSeenQuestions_StudentId_QuestionId",
                table: "StudentSeenQuestions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestAnswers_TestId_QuestionId",
                table: "TestAnswers",
                columns: new[] { "TestId", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TestResults_StudentId_IsLatest",
                table: "TestResults",
                columns: new[] { "StudentId", "IsLatest" },
                filter: "[IsLatest] = 1");
